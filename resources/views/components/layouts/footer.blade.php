...
<footer class="relative mt-20 border-t border-secondary-200 dark:border-secondary-900 dark:bg-black/30">
        ...
        <div class="flex flex-col items-start gap-12 lg:flex-row lg:gap-24 sm:gap-20">
            <div class="flex flex-col max-w-sm shrink-0 gap-7">
                ...
                <p class="max-w-lg mx-auto text-lg font-medium leading-8 text-secondary-500 dark:text-secondary-400 dark:font-normal">
                   ...
                   Experienced Freelance Web Developer specializing in Laravel Blade, Tailwind CSS, Tailwind UI and Alpine JS. Let's bring your web projects to life.
                </p>
                <div class="flex items-center gap-5 mt-2">
                    ...
                    <a href="https://github.com/Subtain-Farooq" aria-label="GitHub">
                        <svg class="transition-colors duration-300 ease-in-out fill-current w-9 h-9 text-secondary-700 dark:text-secondary-400 hover:text-primary-500 dark:hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="fill-current" viewBox="0 0 256 256"><path d="M206.13,75.92A57.79,57.79,0,0,0,201.2,29a6,6,0,0,0-5.2-3,57.77,57.77,0,0,0-47,24H123A57.77,57.77,0,0,0,76,26a6,6,0,0,0-5.2,3,57.79,57.79,0,0,0-4.93,46.92A55.88,55.88,0,0,0,58,104v8a54.06,54.06,0,0,0,50.45,53.87A37.85,37.85,0,0,0,98,192v10H72a26,26,0,0,1-26-26A38,38,0,0,0,8,138a6,6,0,0,0,0,12,26,26,0,0,1,26,26,38,38,0,0,0,38,38H98v18a6,6,0,0,0,12,0V192a26,26,0,0,1,52,0v40a6,6,0,0,0,12,0V192a37.85,37.85,0,0,0-10.45-26.13A54.06,54.06,0,0,0,214,112v-8A55.88,55.88,0,0,0,206.13,75.92ZM202,112a42,42,0,0,1-42,42H112a42,42,0,0,1-42-42v-8a43.86,43.86,0,0,1,7.3-23.69,6,6,0,0,0,.81-5.76,45.85,45.85,0,0,1,1.43-36.42,45.85,45.85,0,0,1,35.23,21.1A6,6,0,0,0,119.83,62h32.34a6,6,0,0,0,5.06-2.76,45.83,45.83,0,0,1,35.23-21.11,45.85,45.85,0,0,1,1.43,36.42,6,6,0,0,0,.79,5.74A43.78,43.78,0,0,1,202,104Z"></path></svg>
                    </a>
                    <a href="https://www.linkedin.com/in/subtain-farooq/" aria-label="LinkdIn">
                        <svg class="transition-colors duration-300 ease-in-out fill-current w-9 h-9 text-secondary-700 dark:text-secondary-400 hover:text-primary-500 dark:hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="fill-current" viewBox="0 0 256 256"><path d="M216,26H40A14,14,0,0,0,26,40V216a14,14,0,0,0,14,14H216a14,14,0,0,0,14-14V40A14,14,0,0,0,216,26Zm2,190a2,2,0,0,1-2,2H40a2,2,0,0,1-2-2V40a2,2,0,0,1,2-2H216a2,2,0,0,1,2,2ZM94,112v64a6,6,0,0,1-12,0V112a6,6,0,0,1,12,0Zm88,28v36a6,6,0,0,1-12,0V140a22,22,0,0,0-44,0v36a6,6,0,0,1-12,0V112a6,6,0,0,1,12,0v2.11A34,34,0,0,1,182,140ZM98,84A10,10,0,1,1,88,74,10,10,0,0,1,98,84Z"></path></svg>
                    </a>
                    <a href="https://t.me/SubtainFarooq" aria-label="Telegram">
                        <svg class="transition-colors duration-300 ease-in-out fill-current w-9 h-9 text-secondary-700 dark:text-secondary-400 hover:text-primary-500 dark:hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="fill-current" viewBox="0 0 256 256"><path d="M235.57,27.7a7,7,0,0,0-7.13-1.22L25.78,105.79a12.23,12.23,0,0,0,2.1,23.39L82,139.81V200a14,14,0,0,0,24.08,9.71l26.64-27.63,41.58,36.45a13.9,13.9,0,0,0,9.2,3.49,14.33,14.33,0,0,0,4.36-.69,13.86,13.86,0,0,0,9.34-10.17L237.82,34.57A7,7,0,0,0,235.57,27.7ZM30.05,117.37h0a.46.46,0,0,1,0-.32.51.51,0,0,1,.15-.08L189.91,54.45l-103.3,74L30.2,117.41Zm67.39,84A2,2,0,0,1,94,200V148.11l29.69,26Zm88.07,7.08a1.93,1.93,0,0,1-1.34,1.44,2,2,0,0,1-2-.4L97.64,135.34,223,45.5Z"></path></svg>
                    </a>
                    <a href="https://wa.me/+923007998354" aria-label="Whatsapp">
                        <svg class="transition-colors duration-300 ease-in-out fill-current w-9 h-9 text-secondary-700 dark:text-secondary-400 hover:text-primary-500 dark:hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="fill-current" viewBox="0 0 256 256"><path d="M186.68,146.63l-32-16a6,6,0,0,0-6,.38L133,141.46A42.49,42.49,0,0,1,114.54,123L125,107.33a6,6,0,0,0,.38-6l-16-32A6,6,0,0,0,104,66a38,38,0,0,0-38,38,86.1,86.1,0,0,0,86,86,38,38,0,0,0,38-38A6,6,0,0,0,186.68,146.63ZM152,178a74.09,74.09,0,0,1-74-74,26,26,0,0,1,22.42-25.75l12.66,25.32-10.39,15.58a6,6,0,0,0-.54,5.63,54.43,54.43,0,0,0,29.07,29.07,6,6,0,0,0,5.63-.54l15.58-10.39,25.32,12.66A26,26,0,0,1,152,178ZM128,26A102,102,0,0,0,38.35,176.69L26.73,211.56a14,14,0,0,0,17.71,17.71l34.87-11.62A102,102,0,1,0,128,26Zm0,192a90,90,0,0,1-45.06-12.08,6.09,6.09,0,0,0-3-.81,6.2,6.2,0,0,0-1.9.31L40.65,217.88a2,2,0,0,1-2.53-2.53L50.58,178a6,6,0,0,0-.5-4.91A90,90,0,1,1,128,218Z"></path></svg>
                    </a>
                </div>
            </div>
            <div class="w-full">
                <div class="grid grid-cols-1 gap-12 xl:grid-cols-4 lg:grid-cols-2 sm:grid-cols-4 xl:gap-24 sm:gap-10">
                    ...
                    <div class="flex flex-col w-full gap-7">
                        <p class="text-xl font-semibold text-secondary-950 dark:text-white">Hire me</p>

                        <div class="flex flex-col gap-5">
                            <a href="https://www.fiverr.com/subtainfarooq" class="flex items-center gap-2 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 dark:text-secondary-400 hover:text-secondary-950 dark:hover:text-secondary-100">
                                Fiverr
                            </a>
                            <a href="https://upwork.com/freelancers/subtainf2" class="flex items-center gap-2 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 dark:text-secondary-400 hover:text-secondary-950 dark:hover:text-secondary-100">
                                Upwork
                            </a>
                        </div>
                    </div>
