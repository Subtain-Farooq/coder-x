<div class="absolute inset-x-0 top-0">
    ...
    <div class="relative z-20 mx-auto max-w-7xl box">
        <nav class="md:grid content-center lg:grid-cols-3 grid-cols-2 flex items-center justify-between gap-5 py-7 ">
            ...
            <div class="sm:flex hidden items-center lg:justify-center justify-end lg:gap-12 gap-8">
...
<div class="bg-black/60 backdrop-blur-md fixed inset-0 z-50 w-full h-full sm:hidden" x-show="menu" x-cloak x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        <div class="box h-full relative">
        <button @click="menu = false" class=" absolute top-8 right-4 text-rose-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
        </button>
        <div class="flex items-center justify-center flex-col h-full gap-16">
            <a href="/" class="inline-flex items-center gap-2 ">
                <svg class="w-16 h-16 fill-current dark:text-secondary-100 text-secondary-950" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="fill-current" viewBox="0 0 256 256">
                    <path d="M173.19,155c-9.92,17.16-26.39,27-45.19,27s-35.27-9.84-45.19-27a6,6,0,0,1,10.38-6c7.84,13.54,20.2,21,34.81,21s27-7.46,34.81-21a6,6,0,1,1,10.38,6ZM230,128A102,102,0,1,1,128,26,102.12,102.12,0,0,1,230,128Zm-12,0a90,90,0,1,0-90,90A90.1,90.1,0,0,0,218,128ZM92,118a10,10,0,1,0-10-10A10,10,0,0,0,92,118Zm72-20a10,10,0,1,0,10,10A10,10,0,0,0,164,98Z">
                    </path>
                </svg>
                <span class="text-4xl dark:text-secondary-100 text-secondary-950">Coder-X</span>
            </a>
