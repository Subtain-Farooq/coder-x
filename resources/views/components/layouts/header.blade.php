<div class="absolute inset-x-0 top-0">
    ...
    <div class="relative z-20 mx-auto max-w-7xl">
        <nav class="grid content-center grid-cols-3 gap-5 py-5 ">
            <div class="">
            ...
            <div class="flex flex-row-reverse items-center gap-5">
                ...
                <a href="#"
                    class="flex items-center justify-center gap-2 text-lg font-medium text-secondary-950 dark:text-secondary-100 hover:text-secondary-500">
