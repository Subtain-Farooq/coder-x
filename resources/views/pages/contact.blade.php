<x-app-layout>
    <section class="max-w-6xl mx-auto box">
        <div class="flex flex-col w-full gap-16 sm:gap-24">
            ...
            <div class="grid gap-5 text-center sm:grid-cols-2 md:gap-8 md:grid-cols-3">
                <a href="mailto:subtain@coder-x.com" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <x-phosphor-at class="w-12 h-12 fill-current" />
                        subtain@coder-x.com
                    </div>
                </a>
                <a href="https://join.skype.com/invite/YxIgIov1ApEP" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <svg class="w-12 h-12 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Skype for Business</title><path d="M14.04 10.92l-2.52-.56c-.96-.24-2.04-.52-2.04-1.44 0-.92.76-1.56 2.16-1.56 2.84 0 2.6 1.96 4 1.96.72 0 1.36-.4 1.36-1.16 0-1.76-2.8-3.08-5.2-3.08-2.56 0-5.28 1.08-5.28 4 0 1.4.48 2.92 3.24 3.64l3.44.88c1.04.24 1.36.84 1.36 1.36 0 .88-.92 1.84-2.48 1.84-3.08 0-2.64-2.44-4.28-2.44-.72 0-1.32.52-1.32 1.24 0 1.44 1.76 3.4 5.6 3.4 3.68 0 5.52-1.84 5.52-4.24-.04-1.6-.76-3.2-3.56-3.84zm9.08 3.04c.12-.64.16-1.28.16-1.96C23.28 5.76 18.24.72 12 .72c-.68 0-1.32.04-1.96.16C9.04.32 7.92 0 6.72 0 3 0 0 3 0 6.72c0 1.2.32 2.36.88 3.32-.12.64-.16 1.28-.16 1.96 0 6.24 5.04 11.28 11.28 11.28.68 0 1.32-.04 1.96-.16 1 .56 2.12.88 3.32.88C21 24 24 21 24 17.28c0-1.2-.32-2.36-.88-3.32zm-5.84 8.32c-.88 0-1.72-.24-2.48-.64l-.52-.32-.6.12c-.52.08-1.08.16-1.68.16a9.56 9.56 0 01-9.56-9.56c0-.56.04-1.12.16-1.68l.12-.6-.32-.52c-.44-.76-.64-1.6-.64-2.48 0-2.76 2.24-5 5-5 .88 0 1.72.24 2.48.64l.52.32.6-.12c.56-.08 1.12-.16 1.68-.16A9.56 9.56 0 0121.6 12c0 .56-.04 1.12-.16 1.68l-.12.6.32.52c.44.76.64 1.6.64 2.48 0 2.76-2.24 5-5 5Z"/></svg>
                        live:subtainfrq
                    </div>
                </a>

                <a href="https://wa.me/+923007998354" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <x-phosphor-whatsapp-logo class="w-12 h-12 fill-current" />
                        +92 300 799 8354
                    </div>
                </a>
                <a href="https://t.me/SubtainFarooq" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <x-phosphor-telegram-logo class="w-12 h-12 fill-current" />
                        @SubtainFarooq
                    </div>
                </a>
                <a href="https://www.linkedin.com/in/subtain-farooq/" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <x-phosphor-linkedin-logo class="w-12 h-12 fill-current" />
                        subtain-farooq
                    </div>
                </a>
                <a href="https://discordapp.com/users/630670922197499925" class="w-full px-5 py-12 border-2 group rounded-xl border-primary-50 dark:border-primary-300/20 bg-white/50 dark:bg-black/20 backdrop-blur dark:backdrop-blur-lg lg:p-16 sm:p-10">
                    <div  class="flex flex-col items-center gap-4 text-lg font-semibold transition-colors duration-300 ease-in-out text-secondary-500 group-hover:text-secondary-950 dark:group-hover:text-secondary-400">
                        <x-phosphor-discord-logo class="w-12 h-12 fill-current" />
                        .subtainfarooq
                    </div>
                </a>
            </div>

            {{-- <div class="flex flex-col w-full gap-16 xl:flex-row">
                <div class="-mx-5">
                ...
                <div class="w-full xl:max-w-xs shrink-0">
                    ...
                    <div class="flex flex-row flex-wrap gap-8 mt-12 xl:flex-col xl:gap-5">
            ...
            <div class="pt-20 sm:pt-24">
                <div class="relative flex flex-col items-center justify-center gap-8 mb-10 sm:mb-24">
